...
public class XemBoiDetailActivity extends BaseActivity {
    private WebView n;
    XemBoi o;
    String p;

    class a extends WebViewClient {
        a(XemBoiDetailActivity xemBoiDetailActivity) {
        }
    ...
    private void q() {
        ...
        try {
            this.p = String.format("<center><b>%s</b></center><b>%s</b><br>%s", new Object[]{this.o.a, vn.net.vac.base.c.e.a.a(this.o.b, h.a(this).a()), vn.net.vac.base.c.e.a.a(this.o.c, h.a(this).a())});
        } catch (Exception e) {
            e.printStackTrace();
        }
        this.p = this.p.replace("font-family", "font-family-xxx");
        this.p = this.p.replace("font-size", "font-size-xxx");
        String str = "file:///android_asset/XemBoi/AnhXemBoi/";
    ...
    private void r() {
        if (getIntent().getExtras() != null) {
            this.o = (XemBoi) getIntent().getSerializableExtra("EXTRA_XEM_BOI");
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_xem_boi_detail);
        r();
        t();
        q();
        s();
