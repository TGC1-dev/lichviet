...
public class XuatHanhActivity extends BaseActivity {
    private WebView n;

    class a extends WebViewClient {
        a(XuatHanhActivity xuatHanhActivity) {
        }
    ...
    private void q() {
        ...
        this.n.loadUrl("file:///android_asset/XuatHanh/xuathanh.html");
    ...
    private void t() {
        a(R.drawable.btn_back_2, "XUẤT HÀNH ĐẦU XUÂN", 0);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_xuat_hanh);
        r();
        t();
        q();
        s();
